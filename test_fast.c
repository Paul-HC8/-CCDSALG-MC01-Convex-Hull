/*
    ...
    PURPOSE OF THIS FILE: driver for the FAST (Quick-sort) version of Graham's Scan.
    ...
    HOW TO COMPILE & RUN:
        gcc test_fast.c -o test_fast
        ./test_fast
*/

#include <stdio.h>
#include <stdlib.h>
#include "graham_fast.c"   /* brings in the fast Graham's Scan (and stack + sort) */
